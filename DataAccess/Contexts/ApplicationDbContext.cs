    ...
    public class ApplicationDbContext(DbContextOptions<ApplicationDbContext> options) : DbContext(options)
    {
        ...
        public static void Initialize(ModelBuilder modelBuilder)
        {
            ...
            var movies = new Movie[]
            {
                ...
                new Movie { Id = 16, Title = "Ущелина", Director = "Скотт Деріксон", Duration = 129, Cast = "Майлз Теллер , Аня Тейлор", GenreId = genres[0].Id,ReleaseDate = new DateOnly(2025,02,14), Description = "З дна ущелини показується зло", MinAge = 16, Rating = 7.8, StatusId = movieStatuses[0].Id, PosterURL= "https://image.tmdb.org/t/p/original/hIiapyCB7FPTjq3Kar2Bcp2Iu7p.jpg", BannerURL = "https://image.tmdb.org/t/p/original/9nhjGaFLKtddDPtPaX5EmKqsWdH.jpg", TrailerURL = "https://youtu.be/rUSdnuOLebE" },
                new Movie { Id = 17, Title = "Небезпечний рейс", Director = "Джон Мур", Duration = 122, Cast = "Ліам Нісон, Віра Фарміга", GenreId = genres[5].Id, ReleaseDate = new DateOnly(2025, 6, 10), Description = "Агент безпеки намагається врятувати пасажирів рейсу від таємного терориста.", MinAge = 16, Rating = 7.5, StatusId = movieStatuses[0].Id, PosterURL = "https://image.tmdb.org/t/p/original/33EP1IfG3Np8j8BWSaKpqX9c24I.jpg", BannerURL = "https://image.tmdb.org/t/p/original/rOMLLMGgDgGG6XeT3P8sUdUb8nl.jpg", TrailerURL = "https://youtu.be/mLVUgkLT47k" },
                new Movie { Id = 18, Title = "Панда патруль", Director = "Том МакГрат", Duration = 95, Cast = "Джек Блек, Бенедикт Камбербетч", GenreId = genres[2].Id, ReleaseDate = new DateOnly(2025, 8, 2), Description = "Група веселих панд рятує світ від злого лиходія.", MinAge = 6, Rating = 7.9, StatusId = movieStatuses[0].Id, PosterURL = "https://image.tmdb.org/t/p/original/wtj5JFzYdI4fAJIfM7OkL38ddmp.jpg", BannerURL = "https://image.tmdb.org/t/p/original/u7AZ5CdT2af8buRjmYCPXNyJssd.jpg", TrailerURL = "https://youtu.be/DBqHt6iNKxg" },
                new Movie { Id = 19, Title = "Крейвен-мисливець", Director = "Дж. С. Чандор", Duration = 132, Cast = "Аарон Тейлор-Джонсон, Рассел Кроу", GenreId = genres[0].Id, ReleaseDate = new DateOnly(2025, 10, 15), Description = "Легендарний мисливець на супергероїв виходить на полювання.", MinAge = 18, Rating = 8.1, StatusId = movieStatuses[0].Id, PosterURL = "https://image.tmdb.org/t/p/original/tzWswZ7gL6A8Znw0dFGjnBdsUXW.jpg", BannerURL = "https://image.tmdb.org/t/p/original/1ulX4rDlS97lbDi929PUrEi507V.jpg", TrailerURL = "https://youtu.be/fjyKbnjlBkQ" },
                new Movie { Id = 20, Title = "Веном: Останній танець", Director = "Енді Серкіс", Duration = 140, Cast = "Том Харді, Вуді Гаррельсон", GenreId = genres[3].Id, ReleaseDate = new DateOnly(2025, 12, 20), Description = "Веном стикається з найнебезпечнішим ворогом у фінальній битві.", MinAge = 16, Rating = 8.2, StatusId = movieStatuses[0].Id, PosterURL = "https://image.tmdb.org/t/p/original/88pz7b8x2ZZ6UuG2LXrEzqP6HCh.jpg", BannerURL = "https://image.tmdb.org/t/p/original/vZG7PrX9HmdgL5qfZRjhJsFYEIA.jpg", TrailerURL = "https://youtu.be/JkG12Q-AlaI" }
